...
/**
 * Travelling_Sales_Person_Dynamic
 */
public class Travelling_Sales_Person_Dynamic {
  ...
  public static void main(String[] args) {
    ...
    for (i = 1; i <= n; i++)
      path[i] = i;
    Travelling_Sales_Person_Dynamic obj = new Travelling_Sales_Person_Dynamic();
    mincost = obj.tsp(path, 1, n);
    System.out.println("++++Traveling Sales Person Tour++++\n");
    for (i = 1; i <= n; i++)
